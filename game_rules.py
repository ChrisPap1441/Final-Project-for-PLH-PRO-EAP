...
class Rules(tk.Tk):
    def __init__(self):
        ...
        #---------------Info-----------------#
        #Κείμενο με τους κανόνες του παιχνιδιού
        self.rules_text = open('game_rules.txt', encoding="utf8").read()
        self.info_title = tk.Label(self, background= "lightgrey", width=100, borderwidth = 2, relief = "solid", text = self.rules_text, font= 55)
