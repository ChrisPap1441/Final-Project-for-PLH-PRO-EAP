class Player:
    def __init__(self):
        #Μεταβλητή με τους συνολικούς πόντους του παίκτη
        self.highscore = 0
        #Λίστα που περιέχει τους πόντους κάθε λέξης που δημιούργησε σε 1 γύρο ο παίκτης
        self.potential_points = []
        #Μεταβλητή για τον υπολογισμό των πόντων της λέξης στην τωρινή στιγμή 
        self.current_word_score = 0
        #Τα γράμματα που έχει στο χέρι του ο παίκτης 
        self.hands_letters = []
        #Τα γράμματα που έχει τοποθετήσει στο ταμπλό ο παίκτης 
        self.used_letters = []
        #Τα γράμματα που περιέχει η λέξη του παίκτη 
        self.word_letters = []
        ...
        #  όταν βάσει κανόνων ο παίκτης θα πρέπει να χρησιμοποιήσει ένα από αυτά σε επόμενους γύρους
        ...
        #Μεταβλητή που έχει τιμή True αν η λέξη του παίκτη είναι οριζόντια
        self.x_axis = True
        #Μεταβλητή που έχει τιμή True αν η λέξη του παίκτη είναι κάθετη
        self.y_axis = True
    ...
    #Μέθοδος στην οποία επιβεβαιώνουμε τον άξονα στον οποίο βρίσκεται η λέξη
    #Κάνουμε προσπέλαση τις λίστες και η λίστα που οι τιμές της είναι όλες διαφορετικές
    #Τότε αφήνουμε την μεταβλητή του άξονα να παραμείνει True αλλιώς γίνεται False και
    #κάνουμε break την επανάληψη.
    #Στην περίπτωση που ο παίκτης εισάγει με λάθος τρόπο τα γράμματά του
    ...
    #Μέθοδος στην οποία εντοπίζουμε τον άξονα στον οποίο βρίσκεται η λέξη,
    #ώστε να βάλουμε τις ανάλογες τιμές στις μεταβλητές που θα χρησιμοποιήσουμε στην προσπέλαση
    ...
    #ο παίκτης, στη μεταβλητή highscore που περιέχει τους συνολικούς του πόντους
    def add_points(self):
